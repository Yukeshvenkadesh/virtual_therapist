...
// Support multiple frontend origins (comma-separated), default to common dev ports
const allowedOrigins = (process.env.FRONTEND_ORIGIN || "http://localhost:5173,http://localhost:3000").split(",").map(o => o.trim())
app.use(cors({ 
